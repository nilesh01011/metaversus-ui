  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    <motion.div variants={staggerContainer} initial="hidden" whileInView="show" viewport={{ once: false, amount: 0.25 }} className={`${styles.innerWidth} mx-auto ${styles.flexCenter} flex-col`}>
      ...
      <motion.p variants={fadeIn('up', 'tween', 0.2, 1)} className="mt-[8px] font-normal sm:text-[32px] text-[20px] text-center text-secondary-white">
        ...
        is a new thing in the future, where you can enjoy the virtual world by feeling like it's really real, you can feel what you feel in this metaverse world, because world, because this is really the <span className="font-extrabold text-white">madness of the metaverse</span> of tody, using only <span className="font-extrabold">VR</span> devices you easily explore the metaverse world you can easily explore the metaverse world you wnat, turn your dreams into reality, Let's <span className="font-extrabold text-white">explore</span> the madness of the metaverse by scrolling down
      </motion.p>
